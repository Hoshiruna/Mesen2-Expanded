	...
	public class AboutWindow : MesenWindow
	{
		...
		public AboutWindow()
		{
			...
			AcknowledgeList = new List<AboutListEntry>() {
				...
				new("KuLou_D", "", "Mesen Expanded icon", "https://www.pixiv.net/users/92027407"),
				new("Mesen", "", "GPL3", "https://github.com/SourMesen/Mesen2"),
			...
			this.GetControl<TextBlock>("lblCopyright").Text = $"Copyright 2025-{DateTime.Now.Year} Hoshiruna";
		}
		...
		{
			ApplicationHelper.OpenBrowser("https://github.com/Hoshiruna/Mesen2-Expanded");
		}

		private void OnCommitLinkTapped(object? sender, TappedEventArgs e)
		{
			ApplicationHelper.OpenBrowser("https://github.com/Hoshiruna/Mesen2-Expanded/commits/" + BuildSha);
		}
	}
